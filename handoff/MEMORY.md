...
- [verified | user correction + Opus 5.0 expert review + multiple 5.6-sol reviewers + full offline suite | review: 2026-08-31 | expires: next README/product-doc decision] README 已按用户指定的参考项目风格压缩为 109 行：定位、预览、运行要求、快速启动、首位管理员、主要功能、配置、验证、结构和安全许可。已删除长篇项目简介、重复架构/验收说明、文档索引和正文穿插文档链接；并修正本地 `SAAS_PUBLIC_ORIGIN`、商品同步字段和 Chromium 前置条件。仅文档改动，未刷新运行服务、未提交或推送。
